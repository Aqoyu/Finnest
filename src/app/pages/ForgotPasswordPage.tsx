      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl border border-white/60 p-6">
          {!sent ? (
            <>
              <div className="mb-5">
                <h2 className="text-xl font-semibold text-gray-800 mb-1">{t.auth.forgotTitle}</h2>
                <p className="text-sm text-gray-500 font-normal">{t.auth.forgotSubtitle}</p>
              </div>
            ...
            <div className="text-center py-2">
              ...
              <h2 className="text-lg font-semibold text-gray-800 mb-2">{t.auth.emailSentTitle}</h2>
              <p className="text-sm text-gray-500 font-normal mb-1">{t.auth.emailSentSubtitle}</p>
              <p className="text-sm font-medium text-cyan-600 mb-4">{email}</p>
              <p className="text-xs text-gray-400 font-normal">{t.auth.checkSpam}</p>
            </div>
          )}

          <div className="mt-5 pt-4 border-t border-gray-100">
            <Link to="/login" className="flex items-center justify-center gap-1.5 text-sm text-gray-500 hover:text-cyan-600 transition-colors">
