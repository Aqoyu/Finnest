...
export function LoginPage() {
  ...
  const handleGoogle = async () => {
    ...
    if (error) {
      setError(t.auth.googleError + error);
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-teal-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl border border-white/60 p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-1">{t.auth.welcome}</h2>
          <p className="text-sm text-gray-500 mb-5 font-normal">{t.auth.signInSubtitle}</p>
          ...
          <p className="text-center text-sm text-gray-500 mt-5 font-normal">
            {t.auth.noAccount}{" "}
